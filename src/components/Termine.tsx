...
function createData(name: string | undefined, start: string, ende: string) {
    return { name, start, ende };
}
...
const Termine = () => {
    ...
    const rows = termine.map(termin => (
        createData(termin.mieterName, termin.terminBeginn, termin.terminEnde)
    ));
    ...
    //         <TableHead>
    //           <TableRow>
    //             <TableCell align="center">Familienname</TableCell>
    ...
    //                 <TableCell align="center">{termin.mieterName}</TableCell>
    //                 <TableCell align="center">{termin.terminBeginn}</TableCell>
    //                 <TableCell align="center">{termin.terminEnde}</TableCell>
